            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.0001), // 2% of the screen height for spacing
                  ...
                  SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.01), // 1% of the screen height for spacing

                  // "Continue with" text
                  SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.02), // Increase the gap here
                  Text(
                    'CONTINUE WITH',
                  ...
                  SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.01), // 2% of the screen height for spacing
                  ...
                  SizedBox(
                      height: MediaQuery.of(context).size.height *
                          0.02), // 2% of the screen height for spacing
